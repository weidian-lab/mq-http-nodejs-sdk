...
describe('mq client test', () => {
  ...
  describe('API should ok', () => {
    ...
    it('message property invalid, key contains \'', () => {
    ...
    it('message property invalid, value contains <', () => {
      const msgProps = new MessageProperties()
      expect(() => {
        msgProps.putProperty('abc', '123<')
      }).to.throwException()
    ...
    it('publishMessage should ok', async () => {
    ...
    it('publishMessage with properties should ok', async () => {
      const msgProperties = new MessageProperties()
    ...
    it('publishMessage timer should ok', async () => {
      const msgProperties = new MessageProperties()
      msgProperties.putProperty('nodejs', 'true')
    ...
    it('consumeMessage&ackMessage shoule ok', async () => {
    ...
    it('ackMessage handle is illegal should ok', async () => {
    ...
    it('publish transaction msg & commit it', async () => {
      const msgProperties = new MessageProperties()
      msgProperties.putProperty('nodejs', 'true')
